...
object CompetitionsProvider {
  val allCompetitions: Seq[Competition] = Seq(
    ...
    // TODO - fix competition ID one PA have allowed us to see it
    //Competition("000", "/football/womens-super-league", "Women's Super League",  "Women's Super League", "English")
  )
}
